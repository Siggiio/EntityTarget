...
public class NMSUtil_v1_10_R1 extends NMSUtil<NMSUtil_v1_10_R1> {
	...
	public void updateTargets(Player p, Entity entity, String targets) {
		try {
			...
			Map<String, Class<? extends net.minecraft.server.v1_10_R1.Entity>> entityTypes = (Map<String, Class<? extends net.minecraft.server.v1_10_R1.Entity>>) entityTypesField.get(null);
