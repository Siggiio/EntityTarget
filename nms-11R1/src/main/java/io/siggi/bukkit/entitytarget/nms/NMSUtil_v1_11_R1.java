...
public class NMSUtil_v1_11_R1 extends NMSUtil<NMSUtil_v1_11_R1> {
	...
	public void updateTargets(Player p, Entity entity, String targets) {
		try {
			...
			RegistryMaterials<MinecraftKey, Class<? extends net.minecraft.server.v1_11_R1.Entity>> entityTypes = (RegistryMaterials<MinecraftKey, Class<? extends net.minecraft.server.v1_11_R1.Entity>>) entityTypesField.get(null);
