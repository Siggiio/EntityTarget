...
public class NMSUtil_v1_8_R2 extends NMSUtil<NMSUtil_v1_8_R2> {
	...
	public void updateTargets(Player p, Entity entity, String targets) {
		try {
			...
			Map<String, Class<? extends net.minecraft.server.v1_8_R2.Entity>> entityTypes = (Map<String, Class<? extends net.minecraft.server.v1_8_R2.Entity>>) entityTypesField.get(null);
