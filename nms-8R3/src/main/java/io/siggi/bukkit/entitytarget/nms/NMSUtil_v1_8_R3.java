...
public class NMSUtil_v1_8_R3 extends NMSUtil<NMSUtil_v1_8_R3> {
	...
	public void updateTargets(Player p, Entity entity, String targets) {
		try {
			...
			Map<String, Class<? extends net.minecraft.server.v1_8_R3.Entity>> entityTypes = (Map<String, Class<? extends net.minecraft.server.v1_8_R3.Entity>>) entityTypesField.get(null);
			...
			List registeredPathfinders = (List) listField.get(targetSelector);
			listField.setAccessible(false);
			ArrayList toRemove = new ArrayList();
			int x = 1;
			for (int i = 0; i < registeredPathfinders.size(); i++) {
				Object goalItem = registeredPathfinders.get(i);
